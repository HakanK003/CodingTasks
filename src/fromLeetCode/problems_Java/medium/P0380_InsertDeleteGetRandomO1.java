 ...
 *
 * Result
 *   Runtime: 74 ms, faster than 29.31% of Java online submissions for Insert Delete GetRandom O(1).
 *   Memory Usage: 108.9 MB, less than 44.56% of Java online submissions for Insert Delete GetRandom O(1).
 *
 *  Reference
